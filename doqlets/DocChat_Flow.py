...
chat_flow.add_edge("DocumentStore|search", "Prompt|generate_prompt_openai")
chat_flow.add_edge("Prompt|generate_prompt_openai", "LLM|call_llm")
...
chat_flow.set_node_input("Prompt|generate_prompt_openai|instructions", llm_instructions)
chat_flow.add_data_source("Prompt|generate_prompt_openai|context", "DocumentStore|search|results")
chat_flow.add_data_source("Prompt|generate_prompt_openai|query", "INPUTS|query")

chat_flow.add_data_source("LLM|call_llm|messages", "Prompt|generate_prompt_openai|messages")
